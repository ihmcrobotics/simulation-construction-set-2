...
public class BytedecoVideoReader
{
    private final TimestampScrubber timestampScrubber;
    private final String name;

    private final BytedecoWindowsDemuxer demuxer;
    ...
    public BytedecoVideoReader(Camera camera, File dataDirectory, boolean hasTimeBase) throws IOException
    {
        this.camera = camera;
        ...
        demuxer = new BytedecoWindowsDemuxer(dataDirectory, camera);
    ...
    {
        return demuxer.getImageHeight();
    }

    public int getImageWidth()
    {
        return demuxer.getImageWidth();
    }
