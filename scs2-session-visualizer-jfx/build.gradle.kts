...
mainDependencies {
   ...
   api("us.ihmc:euclid:0.20.0-alpha1")
   api("us.ihmc:euclid-shape:0.20.0-alpha1")
   api("us.ihmc:euclid-frame:0.20.0-alpha1")
   api("us.ihmc:ihmc-graphics-description:0.20.2")
   api("us.ihmc:ihmc-video-codecs:2.1.6")
   api("us.ihmc:svgloader:0.0")
   api("us.ihmc:ihmc-javafx-extensions:17-0.2.0")
