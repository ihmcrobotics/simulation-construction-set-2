...
public class BulletBasedRobotLink
{
   ...
   private final ArrayList<BulletBasedRobotLink> children = new ArrayList<>();
   ...
   public BulletBasedRobotLink(RigidBodyDefinition rigidBodyDefinition,
                               ...
                               YoRegistry yoRegistry)
   {
      ...
      for (JointDefinition childrenJoint : rigidBodyDefinition.getChildrenJoints())
      {
         for (JointBasics jointBasics : rigidBodyBasics.getChildrenJoints())
         {
            ...
            {
               children.add(new BulletBasedRobotLink(childrenJoint.getSuccessor(), jointBasics.getSuccessor(), jointNameToBulletJointIndexMap, yoRegistry));
            }
         }
      }
   ...
   public void createBulletCollisionShape(btMultiBody bulletMultiBody, BulletBasedPhysicsEngine bulletPhysicsManager)
   {
   ...
   public BulletBasedRobotLinkCollisionSet getCollisionSet()
   {
      return collisionSet;
   }

   public ArrayList<BulletBasedRobotLink> getChildren()
   {
      return children;
   }
