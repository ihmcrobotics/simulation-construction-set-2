 ...
 */
public class AltBulletPhysicsEngine implements PhysicsEngine
{
   static
   {
      Bullet.init();
   ...
   private final ArrayList<AltBulletTerrainObject> terrainObjects = new ArrayList<>();
   ...
   private final List<AltBulletRobot> robotList = new ArrayList<>();
   ...
   public AltBulletPhysicsEngine(ReferenceFrame inertialFrame, YoRegistry rootRegistry)
   {
...
//      BulletTools.setupPostTickCallback(multiBodyDynamicsWorld, postTickCallbacks);
   ...
   public boolean initialize(Vector3DReadOnly gravity)
   {
      ...
      for (AltBulletRobot robot : robotList)
      {
   ...
   public void addRobot(Robot robot)
   {
      ...
      AltBulletRobot bulletRobot = new AltBulletRobot(robot, physicsEngineRegistry, this);
   ...
   public void addTerrainObject(TerrainObjectDefinition terrainObjectDefinition)
   {
      ...
      terrainObjects.add(new AltBulletTerrainObject(terrainObjectDefinition, multiBodyDynamicsWorld));
   }
   ...
   {
      return robotList.stream().map(AltBulletRobot::getRobot).collect(Collectors.toList());
   }
