...
public class ThrowAwayBulletRobotLinkCollisionShape
{
   private final CollisionShapeDefinition collisionShapeDefinition;
   ...
   public ThrowAwayBulletRobotLinkCollisionShape(CollisionShapeDefinition collisionShapeDefinition,
                                           ReferenceFrame frameAfterParentJoint,
                                           ReferenceFrame linkCenterOfMassFrame)
   {
      this.collisionShapeDefinition = collisionShapeDefinition;
      ...
      collisionShapeDefinitionFrame
            = ThrowAwayReferenceFrameMissingTools.constructFrameWithUnchangingTransformToParent(frameAfterParentJoint,
                                                                                                new RigidBodyTransform(collisionShapeToFrameAfterParentJoint.getRotation(), collisionShapeToFrameAfterParentJoint.getTranslation()));
