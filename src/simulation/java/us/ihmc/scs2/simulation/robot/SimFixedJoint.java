...
{
   public SimFixedJoint(String name, SimRigidBody predecessor, RigidBodyTransformReadOnly transformToParent)
   {
      super(name, predecessor, transformToParent);
   }

   public SimFixedJoint(String name, SimRigidBody predecessor)
   {
      super(name, predecessor);
   }

   public SimFixedJoint(FixedJointDefinition definition, SimRigidBody predecessor)
   {
