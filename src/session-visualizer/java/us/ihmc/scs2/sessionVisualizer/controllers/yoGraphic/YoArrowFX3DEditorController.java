...
import us.ihmc.scs2.sessionVisualizer.yoGraphic.YoArrowFX3D;
...
public class YoArrowFX3DEditorController implements YoGraphicFXCreatorController<YoArrowFX3D>
{
   ...
   @Override
   public void initialize(SessionVisualizerToolkit toolkit, YoArrowFX3D yoGraphicToEdit, Window owner)
   {
