...
import us.ihmc.scs2.sessionVisualizer.yoGraphic.YoPointFX3D;
...
public class YoPointFX3DEditorController implements YoGraphicFXCreatorController<YoPointFX3D>
{
   ...
   @Override
   public void initialize(SessionVisualizerToolkit toolkit, YoPointFX3D yoGraphicToEdit, Window owner)
   {
