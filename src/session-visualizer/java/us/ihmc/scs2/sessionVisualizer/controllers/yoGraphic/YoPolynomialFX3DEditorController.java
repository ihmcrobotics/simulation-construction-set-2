...
import us.ihmc.scs2.sessionVisualizer.yoGraphic.YoPolynomialFX3D;
...
public class YoPolynomialFX3DEditorController implements YoGraphicFXCreatorController<YoPolynomialFX3D>
{
   ...
   @Override
   public void initialize(SessionVisualizerToolkit toolkit, YoPolynomialFX3D yoGraphicToEdit, Window owner)
   {
