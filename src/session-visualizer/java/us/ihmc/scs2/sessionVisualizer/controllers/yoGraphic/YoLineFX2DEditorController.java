...
import us.ihmc.scs2.sessionVisualizer.yoGraphic.YoLineFX2D;
...
public class YoLineFX2DEditorController implements YoGraphicFXCreatorController<YoLineFX2D>
{
   ...
   @Override
   public void initialize(SessionVisualizerToolkit toolkit, YoLineFX2D yoGraphicToEdit, Window owner)
   {
