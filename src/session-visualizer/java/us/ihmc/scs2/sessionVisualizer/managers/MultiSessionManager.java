...
import us.ihmc.scs2.sessionVisualizer.session.SessionInfoController;
import us.ihmc.scs2.sessionVisualizer.session.log.LogSessionManagerController;
import us.ihmc.scs2.sessionVisualizer.session.remote.RemoteSessionManagerController;
...
public class MultiSessionManager
{
   ...
   public MultiSessionManager(SessionVisualizerToolkit toolkit, MainWindowController mainWindowController, SidePaneController sidePaneController)
   {
      ...
      {
         JavaFXMissingTools.runAndWait(() -> stopSession());
