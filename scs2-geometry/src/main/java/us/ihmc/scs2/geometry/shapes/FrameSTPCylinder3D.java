...
import us.ihmc.scs2.geometry.shapes.STPShape3DTools.STPCylinder3DSupportingVertexCalculator;
import us.ihmc.scs2.geometry.shapes.interfaces.FrameSTPCylinder3DBasics;
import us.ihmc.scs2.geometry.shapes.interfaces.FrameSTPCylinder3DReadOnly;
import us.ihmc.scs2.geometry.shapes.interfaces.STPCylinder3DReadOnly;

public class FrameSTPCylinder3D implements FrameSTPCylinder3DBasics
{
    ...
    */
   public FrameSTPCylinder3D(ReferenceFrame referenceFrame)
   {
    ...
    */
   public FrameSTPCylinder3D(ReferenceFrame referenceFrame, double length, double radius)
   {
    ...
    * @throws IllegalArgumentException if {@code length} or {@code radius} is negative.
    */
   public FrameSTPCylinder3D(ReferenceFrame referenceFrame, Point3DReadOnly position, Vector3DReadOnly axis, double length, double radius)
   {
    ...
    *                                         reference frame.
    */
   public FrameSTPCylinder3D(FramePoint3DReadOnly position, FrameVector3DReadOnly axis, double length, double radius)
   {
    ...
    */
   public FrameSTPCylinder3D(ReferenceFrame referenceFrame, Cylinder3DReadOnly other)
   {
    ...
    * @param other          the other cylinder to copy. Not modified.
    */
   public FrameSTPCylinder3D(ReferenceFrame referenceFrame, STPCylinder3DReadOnly other)
   {
      setIncludingFrame(referenceFrame, other);
      setupListeners();
   }
    ...
    * @param other the other cylinder to copy. Not modified.
    */
   public FrameSTPCylinder3D(FrameCylinder3DReadOnly other)
   {
    ...
    * @param other the other cylinder to copy. Not modified.
    */
   public FrameSTPCylinder3D(FrameSTPCylinder3DReadOnly other)
   {
      setIncludingFrame(other);
      setupListeners();
   }
   ...
   @Override
   public FrameSTPCylinder3D copy()
   {
      return new FrameSTPCylinder3D(this);
   }

   /**
    * Tests if the given {@code object}'s class is the same as this, in which case the method returns
    * {@link #equals(FrameSTPCylinder3DReadOnly)}, it returns {@code false} otherwise.
    *
   ...
   {
      if (object instanceof FrameSTPCylinder3DReadOnly)
         return FrameSTPCylinder3DBasics.super.equals((FrameSTPCylinder3DReadOnly) object);
      else
         return false;
   }
    ...
    *
    * <pre>
    * STP Cylinder 3D: [position: (-0.362, -0.617,  0.066 ), axis: ( 0.634, -0.551, -0.543 ), length:  0.170, radius:  0.906, small radius: 0.001, large radius: 1.000] - worldFrame
    * </pre>
    *
   ...
   public String toString()
   {
      ...
      return "STP " + EuclidFrameShapeIOTools.getFrameCylinder3DString(this).replace("]", stpSuffix);
   }
}
