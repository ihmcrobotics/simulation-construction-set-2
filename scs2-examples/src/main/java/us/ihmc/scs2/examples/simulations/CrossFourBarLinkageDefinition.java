 ...
 * </pre>
 */
public class CrossFourBarLinkageDefinition extends RobotDefinition
{
   ...
   public CrossFourBarLinkageDefinition()
   {
                                                                     ...
                                                                     boolean showMassProperties)
   {
      ...
      if (showMassProperties)
      {
         ...
         {
            Vector3D radii = getInertiaEllipsoidRadii(svd.getW(), mass);
    ...
    */
   private static Vector3D getInertiaEllipsoidRadii(Vector3D principalMomentsOfInertia, double mass)
   {
